...
export default function Main({ navigation }) {
  ...
  const [matchDev, setMatchDev] = useState([null]); //estado de um variavel
  ...
  async function handleLike() {
    const [user, ...rest] = users; // pego o primero user do array e salvo no user, e o resto eu salvo no rest
